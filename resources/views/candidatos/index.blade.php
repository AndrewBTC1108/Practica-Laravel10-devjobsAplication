                        ...
                        <ul class="divide-y divide-gray-200 w-full">
                            @forelse ($vacante->candidatos as $candidato )
                                <li class="p-3 flex items-center">
                                    ...
                                    <div>
                                        <a
                                            class="inline-flex items-center shadow-sm px-2.5 py-0.5 border border-gray-300 text-sm leading-5
                            ...
                            @empty
                                <p class="p-3 text-center text-sm text-gray-600">No hay candidayos aún</p>
                            @endforelse
                        </ul>
                    </div>
                </div>
